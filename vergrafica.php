...
<script type="text/javascript" >
	...
	var por5=45*arseInt(ivalort5.value)/totalegresos;
	...
	/*El radio de la circunferencia aumenta cuando aumenta el porcentaje pero teniendo encuenta el tamaño de los egresos totales (radius 45), para que el gráfico no siga creciendo de forma incontrolable.*/
